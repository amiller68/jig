...
### 2026-02-18 - Ready for Review
- Implementation complete
- Moved worktrees from .worktrees/ to .jig/, state to .jig/.state/state.json
- Added auto-migration from legacy layout
- kill/unregister now removes workers entirely instead of archiving
- list_tasks auto-cleans stale workers before listing
